//{"name":"G2. Ruler (hard version)","group":"Codeforces - Codeforces Round 964 (Div. 4)","url":"https://codeforces.com/contest/1999/problem/G2","interactive":true,"timeLimit":1000,"tests":[{"input":"2\n\n18\n\n25\n\n\n9999\n","output":"? 3 5\n\n? 4 4\n\n! 4\n? 99 100\n\n! 100\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"G2RulerHardVersion"}}}
...
fn solve(interactor: &mut Interactor) {
    ...
    while lo < hi {
        let mid1 = (2 * lo + hi) / 3;
        let mid2 = (lo + 2 * hi) / 3;
        let area = interactor.query(mid1, mid2);
        if area == mid1 * mid2 {
            lo = mid2 + 1;
