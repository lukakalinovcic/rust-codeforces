//{"name":"C2. Message Transmission Error (hard version)","group":"Codeforces - Testing Round 19 (Div. 3)","url":"https://codeforces.com/contest/2010/problem/C2","interactive":false,"timeLimit":2000,"tests":[{"input":"abrakadabrabrakadabra\n","output":"YES\nabrakadabra\n"},{"input":"acacacaca\n","output":"YES\nacacaca\n"},{"input":"abcabc\n","output":"NO\n"},{"input":"abababab\n","output":"YES\nababab\n"},{"input":"tatbt\n","output":"NO\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"C2MessageTransmissionErrorHardVersion"}}}
